...
const App = () => {
    ...
    const findWinner = () => {
        if (tiktacArray[0] === tiktacArray[1] && tiktacArray[0] === tiktacArray[2] && tiktacArray[0] != "") {
            ...
            setWinMessage(tiktacArray[0] + " has won")
        } else if (tiktacArray[0] !== "" && tiktacArray[1] !== "" && tiktacArray[2] !== "" && tiktacArray[3] !== "" && tiktacArray[4] !== "" && tiktacArray[5] !== "" && tiktacArray[6] !== "" && tiktacArray[7] !== "") {
            setWinMessage("Game graw")
        }
    }
                ...
                <Col md={6} className="offset-md-3">
                    {
                        winMessage ? (
                            <div>
                                <h1 style={{ color: 'white', textAlign: 'center' }} className="text-center"> {winMessage} </h1>
                                <div className="b">
